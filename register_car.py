...
async def register_car(kanton: str, kennzeichen: str) -> bool:
    async with async_playwright() as p:
        ...
        await page.get_by_placeholder("E-Mail Adresse").fill("test@yopmail.com")
...
if __name__ == "__main__":
    asyncio.run(register_car("ZH", "123456"))
